...
(** Formatted output at the current position. *)
val printw : ('a, unit, string, err) format4 -> 'a
val mvprintw : int -> int -> ('a, unit, string, err) format4 -> 'a
val wprintw : window -> ('a, unit, string, err) format4 -> 'a
val mvwprintw : window -> int -> int -> ('a, unit, string, err) format4 -> 'a
